...
import kotlinx.android.synthetic.main.activity_upload_place.*
...
class UploadPlaceActivity : AppCompatActivity() {
    ...
    fun uploadPlaceClicked (view: View) {
        ...
        if (selectedPicture != null) {
            imagesReference.putFile(selectedPicture!!).addOnSuccessListener { taskSnapshot ->
                ...
                uploadedPictureReference.downloadUrl.addOnSuccessListener { uri ->
                    ...
                    postMap.put("placeName",uploadNameText.text.toString())
                    postMap.put("information",uploadInfoText.text.toString())
                    postMap.put("date", Timestamp.now())


                    db.collection( "Places").add(postMap).addOnCompleteListener{task ->
